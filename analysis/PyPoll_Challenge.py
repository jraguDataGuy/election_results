...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if(cvotes > county_voter_turnout) and (cvotes_percentage > largest_percentage):
    ...
    largest_county_summary = (f"-------------------------\n"
        ...
        f"Total Vote Count: {county_voter_turnout:,}\n"
        f"Total Vote Percentage: {largest_percentage:.1f}%\n"
        f"-------------------------\n")
